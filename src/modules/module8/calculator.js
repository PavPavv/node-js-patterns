...
function main() {
  ...
  const enhancedCalc = new EnhancedCalculator(calculator);
  // enhancedCalc.putValue(4);
  // enhancedCalc.putValue(3);
  // console.log(enhancedCalc.add());

  // safeCalculator.putValue(2);
  // console.log(safeCalculator.multiply());

  const enhancedCalcHandler = {
    get: (target, property) => {
      // new method
      if (property === 'add') {
  ...
  // const enhancedProxyCalculator = new Proxy(calculator, enhancedCalcHandler);
}
main();